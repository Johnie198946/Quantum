...
5. 素材任务只补双封面及三张正文插图，不冒充原作者。独立审核通过现有原生证明；main 使用原有审核协议，Story 使用 story-supervision-v2 和 supervision。 修订合同保留旧缺口为 open，独立签名 review 通过 gap_resolutions 逐项说明真实补证或合理收缩范围；程序随后关闭已有缺口账本，不回写冻结合同或让作者补状态。
