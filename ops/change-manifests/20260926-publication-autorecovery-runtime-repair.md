...
- Local verification: `144 passed` across Workflow handoff, watchdog, editorial, editorial workflow and Workflow scheduler suites; focused Ruff and `git diff --check` passed. Four existing Pydantic v2 deprecation warnings remain.
